 ...
 */
@Slf4j
public class BaseRocketMQTemplate extends RocketMQTemplate implements CommandLineRunner {
    ...
    public void setTemplate(RocketMQTemplate template) {
        ...
        this.setProducer(template.getProducer());
        this.setConsumer(template.getConsumer());
        this.setMessageQueueSelector(template.getMessageQueueSelector());
        this.setMessageConverter(template.getMessageConverter());
    }
    ...
    public void run(String... args) throws Exception {
        if (!this.getClass().getName().equals("rocketMQTemplate")) {
            setTemplate(this);
        }
